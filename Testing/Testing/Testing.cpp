...
struct Queue
{
    ...
    // int front(): 
    // The front variable keeps track of the "logical" front of the queue,
    // allowing elements to be dequeued in a FIFO (First-In-First-Out) manner
    // without having to shift all elements in the array.
...
void Prim(Graph& x) 
{
    ...
    //the MST contains sodinh - 1 edges(where sodinh is the total number of vertices).
    //This is because a tree with V vertices has exactly V - 1 edges.
